...
const NewTask = ({data}) => {
  return (
    <div className="flex-shrink-0 h-full rounded-xl p-5 bg-blue-600 w-[350px]">
            ...
            <p className='mt-5 text-sm '>{data.taskDescription}</p><div className='mt-3'>
                <button className='w-full px-2 py-1 bg-yellow-500 rounded-md shadow-lg'>Accept Task</button>
            </div>
        </div>
  )
}
